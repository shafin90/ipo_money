        ...
        <div className='customNavbar w-full flex justify-center items-center  sticky top-0  transition-all h-24 z-50'>
            ...
            <div className=' w-11/12 flex justify-between items-center'>
                ...
                <ul className=' flex justify-between items-center '>
                    <li><Link href="" className=' text-blue-900 text-lg font-semibold cursor-pointer hover:text-green-900 transition-all px-7 py-4 hover:shadow-2xl rounded-md'>IPO GMP</Link></li>
                    <li><Link href="" className=' text-blue-900 text-lg font-semibold cursor-pointer hover:text-green-900 transition-all px-7 py-4 hover:shadow-2xl rounded-md'>IPO Subccription</Link></li>
                    <li><Link href="" className=' text-blue-900 text-lg font-semibold cursor-pointer hover:text-green-900 transition-all px-7 py-4 hover:shadow-2xl rounded-md'>Latest IPO Updates</Link></li>
                </ul>
