...
const ContactUs = () => {
  return (
    <div id="contact-us" className='w-11/12 mx-auto mb-96 '>
      ...
      <div className="hero border border-dashed bg-gray-50 hover:bg-gray-100 transition-all text-slate-600 rounded-2xl py-24 px-6">
          ...
          <div className="card shrink-0 w-full max-w-sm shadow-2xl bg-gray-50  transition-all text-slate-600 ">
            <form className="card-body">
              ...
              <div className="form-control mt-6">
                <button className="btn bg-blue-200 hover:bg-blue-300 transition-all rounded-md border-0">Submit</button>
              </div>
            </form>
          </div>
        </div>
